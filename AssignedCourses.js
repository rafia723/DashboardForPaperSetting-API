...
"SELECT  ac.ac_id, ac.c_id,ac.f_id,f.f_name AS 'TeacherName', c.c_title AS 'CourseTitle', c.c_code AS 'CourseCode', ac.role FROM faculty f JOIN Assigned_Course ac ON f.f_id = ac.f_id JOIN course c ON ac.c_id = c.c_id WHERE c.c_id =@c_id";
...
// GET endpoint
AssignedCoursesRouter.get("/getAssignedCourses/:f_id", async (req, res) => {  //HOD SCREEN 3
  try {
...
// GET endpoint
AssignedCoursesRouter.get("/getAssignedTo/:c_id", async (req, res) => { //HOD SCREEN 7
  try {
